...
class ServiceController extends Controller
{
    ...
    public function update(UpdateServiceRequest $request, Service $service)
    {
        ...
        // if($request->has("image") || $request->has("image_single")){

        //     if($request->has("image")){
        //         $this->repositoryService->update($this->getServiceUpdate($request),$service);

        //         $service->image=$this->uploadFileUpate($request->file('image'),'/images/services/card/',$service->image);
        ...
        //         $service->image_single=$this->uploadFileUpate($request->file('image_single'),'/images/services/single/',$service->image_single);
