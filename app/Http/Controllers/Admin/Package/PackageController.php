...
class PackageController extends Controller
{
    ...
    public function update(UpdatePackageRequest $request, Package $package)
    {
        ...
        //         $package->image=$this->uploadFileUpate($request->file('image'),'/images/packages/card/',$package->image);
        ...
        //         $package->image_single=$this->uploadFileUpate($request->file('image_single'),'/images/packages/single/',$package->image_single);
