                    ...
                    <div class="col-12">
                        <div class="card shadow p-3 mb-5 bg-body rounded" style="width: 10rem;">
                            ...
                            <a href="{{ route('admin.download', $order->file) }}"><img
                                    src="{{ asset('storage/images/orders/attachments/'.$order->file) }}" class="card-img-top" /></a>
                            @else
                            <a href="{{ route('admin.download', $order->file) }}"><img
            ...
            <div class="table-responsive mb-4 mt-4">
                <table id="zero-config" class="table table-hover" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            <td>{{ $order->code }}</td>
                            <td>@if ($order->description_cust!=null)
                                <?php echo nl2br(e($order->description_cust));  ?>
                               @else
                            ...
                            <td>
                               @can('download-file')
                                ...
                                <div class="d-flex align-items-center">
                                    @if(in_array(explode(".",$order->file)[1],['png','jpg','webp']))
                                    <a href="{{ route('admin.download', $order->file) }}"><img
                                            style="width: 35px;height: 35px;"
                                            src="{{ asset('storage/images/orders/attachments/'.$order->file) }}" /></a>
                                    @else
                                    <a href="{{ route('admin.download', $order->file) }}"><img
                                            style="width: 35px;height: 35px;"
