...
@section('title', __('admin.all_assign'))

@section('page-title', __('admin.all_assign'))
@section('css')
<style>
.lds-dual-ring {
                ...
                <table id="zero-config" class="table table-hover table-bordered mb-4" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr id="{{ $assignedtas->id }}">
                            ...
                            <td>@if(App\Models\User::where("id",$assignedtas->user_task_id)->first()!=null) {{ App\Models\User::where("id",$assignedtas->user_task_id)->first()->firstname.' '.App\Models\User::where("id",$assignedtas->user_task_id)->first()->lastname}} @endif</td>
