                    ...
                    <div class="widget widget-account-invoice-two w-100">
                        <div class="widget-content">
                            <div class="account-box">
                                <div class="info">
                                    <a href="{{ route('user.orders.index') }}">
                                        <h5 class="">@lang('admin.orders_canceld')</h5>
                                    </a>
                                    <p class="inv-balance"
                                        style="font-size: 20px;    color: #dccff7;background-color: #dc3545;height: 45px;display: inline-flex;width: 45px;
            align-self: center;
            justify-content: center;
            border-radius: 50%;
            padding: 10px;">
                                        {{ $orders_canceld->count() }}</p>
                                </div>
                                <div class="acc-action">
                                    <div class="">
