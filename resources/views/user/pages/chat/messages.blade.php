...
<form id="form" >
    <div class="c"> 
      <button type="button" class="btn-close"onclick="cl()" aria-label="Close"></button>
      <div >تواصل مباشرة معنا   </div>
    </div>
              ...
              @foreach ($messages as $message)
                  <div class="{{ ($message->from == Auth::id()) ? 'right' : 'left' }}">
                      <div class="chat-track">
                          ...
                          <h5 class="user-name text-white" >أنت</h5>
                          @else
                          <div class="d-flex align-items-center justify-content-end gap-2">
                              <img src="{{asset('assets/images/chat/support.svg')}}" alt="support">
                              <h5 class="user-name" >فريق الدعم</h5>
    ...
    <div class="message2">
        ...
        <div class="s">
          <input type="submit" class="submit1" name="button" value=" ارسال ">
