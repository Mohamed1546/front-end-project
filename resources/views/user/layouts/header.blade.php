    ...
    <header class="header navbar navbar-expand-sm expand-header">
        ...
        <ul class="navbar-item flex-row ml-auto">
            <li class="nav-item dropdown notification-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle helper">
                    <i class="fa-solid fa-headset"></i>
                    {{-- <img src="{{asset("assets/images/10206074.png")}}" style="    height: 35px;
                    width: 35px;" alt="" srcset=""> --}}
                </a>
            </li>
            <li class="nav-item dropdown notification-dropdown">
                ...
                <div class="dropdown-menu position-absolute e-animated e-fadeInUp"
                    ...
                    <div class="user-profile-section">
                        <div class="media mx-auto">
                            <img src="<?php if(Auth::user()->userprofile): if(Auth::user()->userprofile->profile_image!=null): echo asset('storage/images/userprofile/'.Auth::user()->userprofile->profile_image); else: echo asset('assets\images\images.jpg'); endif; else: echo asset('assets\images\images.jpg') ; endif; ?>" class="img-fluid mr-2"
                                alt="avatar">
